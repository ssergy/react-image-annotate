    ...
    case "MOUSE_MOVE":
      {
        ...
        if (!activeImage) return state; //const { mouseDownAt } = state
          ...
          case "MOVE_REGION":
            {
              ...
              if (_regionId2 === "$$allowed_area") {
                var _state = state,
                    _state$allowedArea = _state.allowedArea,
                    w = _state$allowedArea.w,
                    h = _state$allowedArea.h;
          ...
          case "SET_EXPANDING_LINE_WIDTH":
            {
              ...
              var _lastPoint = _expandingLine.points.slice(-1)[0]; //const { mouseDownAt } = state
    ...
    case "MOUSE_UP":
      {
        var _x2 = action.x,
            _y2 = action.y;
        var _state2 = state,
            _state2$mouseDownAt = _state2.mouseDownAt,
            mouseDownAt = _state2$mouseDownAt === void 0 ? {
          x: _x2,
          y: _y2
        } : _state2$mouseDownAt;
        if (!state.mode) return state;
          ...
          case "DRAW_EXPANDING_LINE":
            {
              ...
              var _lastPoint3 = _expandingLine4.points.length !== 0 ? _expandingLine4.points.slice(-1)[0] : mouseDownAt;
              /*let jointStart
