...
import useEventCallback from "use-event-callback"; // import {UploaderSidebarBox} from "../UploaderSidebarBox/index";
...
export var MainLayout = function MainLayout(_ref2) {
  var state = _ref2.state,
      ...
      _ref2$showUploadButto = _ref2.showUploadButton,
      showUploadButton = _ref2$showUploadButto === void 0 ? false : _ref2$showUploadButto,
  ...
  var canvas = /*#__PURE__*/React.createElement(ImageCanvas, Object.assign({}, settings, {
    ...
    regions: state.annotationType === "image" ? (activeImage ? activeImage.regions : []) || [] : impliedVideoRegions,
  ...
  return /*#__PURE__*/React.createElement(FullScreenContainer, null, /*#__PURE__*/React.createElement(FullScreen, {
    ...
    }), state.images && state.images.length > 0 && /*#__PURE__*/React.createElement(ImageSelector, {
