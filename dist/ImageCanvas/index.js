...
export var ImageCanvas = function ImageCanvas(_ref2) {
  ...
  var _useRafState = useRafState(false),
      ...
      changeDragging = _useRafState2[1]; //const [maskImagesLoaded, changeMaskImagesLoaded] = useRafState(0)


  var _useRafState3 = useRafState(null),
  ...
  var _useRafState7 = useRafState(getDefaultMat()),
      _useRafState8 = _slicedToArray(_useRafState7, 2),
      mat = _useRafState8[0],
      changeMat = _useRafState8[1]; //const maskImages = useRef({})
  ...
  var handleChangeMat = useCallback(function () {
    changeMat(mat.clone());
  }, [mat, changeMat]);
  useLayoutEffect(function () {
    return handleChangeMat();
  }, [windowSize, handleChangeMat]);
